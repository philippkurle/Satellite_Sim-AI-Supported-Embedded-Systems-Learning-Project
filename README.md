...
- I noticed early on that some parts of C++ felt familiar because of my previous exposure to Python. Concepts such as arrays, variables, constants, and functions gave me a starting point, even though the overall structure and syntax were new to me. I also came across `enum class` definitions for the first time and began to understand their role in representing clearly defined system states.
